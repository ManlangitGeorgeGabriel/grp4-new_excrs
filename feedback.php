...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    <head>
        ...
        <link rel="stylesheet" href="feedback.css"> <!-- Link to your CSS -->
    ...
    <body>
        <div class="container">
            ...
            <a href="http://localhost/new_project_grp4/jabby.php#feedback"><button>Submit another feedback</button></a>
        </div>
    </body>
    </html>';
} else {
